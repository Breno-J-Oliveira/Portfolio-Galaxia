    ...
    public function criar(array $dados): void {
        try {
            ...
            if (isset($_FILES['foto'])) {
                ...
                // Caminho de destino
                $upload_dir = __DIR__ . '/../../public/uploads/produtos/';
                ...
                $foto_url = "/PROJETO-ARQUON/public/uploads/produtos/" . $nome_arquivo;
        ...
        try {
            ...
            if ($sucesso) {
                ...
                if ($produto && $produto['foto_url']) {
                    $caminho_arquivo = __DIR__ . '/../../public' . str_replace('/PROJETO-ARQUON/public', '', $produto['foto_url']);
