...
(function () {
  ...
  /* ============================================================
     DATA — PROJETOS (estrelas principais)
  ============================================================ */
  const NAV_STARS = [
    {
      id: 'sobre',
      name: 'Sobre Mim',
      desc: 'Quem sou, minha trajetória como Backend Developer & Systems Engineer.',
      tags: ['Backend', 'Sistemas', 'SENAI'],
      color: '#00ffff',
      url: 'about.html',
      angle: 30,
      dist: 0.18,
    ...
    },
    {
      id: 'api',
      name: 'APIs & Backend',
      desc: 'APIs RESTful robustas e sistemas escaláveis com Node.js e Python.',
    ...
    },
    {
      id: 'iot',
      name: 'IoT & Embarcados',
      desc: 'Sistemas embarcados e automação com Arduino, ESP32 e Raspberry Pi.',
      tags: ['Arduino', 'ESP32', 'C/C++', 'MQTT'],
      color: '#ffdd00',
      url: 'projects.html',
      angle: 185,
      dist: 0.20,
    ...
    },
    {
      id: 'automacao',
      name: 'Automação',
      desc: 'Scripts, bots e pipelines que eliminam trabalho repetitivo.',
      tags: ['Python', 'Shell', 'CI/CD', 'Docker'],
      color: '#00ff88',
      url: 'projects.html',
      angle: 260,
      dist: 0.19,
    ...
    },
    {
      id: 'servicos',
      name: 'Serviços',
      desc: 'Desenvolvimento backend, IoT e automação sob medida para seu negócio.',
      tags: ['Freelance', 'Backend', 'IoT', 'Automação'],
      color: '#ff4444',
      url: 'services.html',
      angle: 330,
      dist: 0.21,
    ...
    },
    {
      id: 'contato',
      name: 'Contato',
      desc: 'Tem um projeto? Vamos conversar e construir algo funcional juntos.',
      tags: ['Projetos', 'Freelance', 'Parceria'],
      color: '#4466ff',
      url: 'contact.html',
      angle: 145,
      dist: 0.25,
  ...
  function updateTooltip(star, mx, my) {
    ...
    if (ttLabel) ttLabel.textContent = `PROJETO — ${star.id.toUpperCase()}`;
